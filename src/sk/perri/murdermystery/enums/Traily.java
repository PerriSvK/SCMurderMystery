...
public class Traily
{
    ...
    private static String[] perm =
        {
            "heart", "spell", "witch", "flame", "lava", "totem", "note", "dmg", "slime", "snowball", "angry", "happy",
            "redstone", "water", "crit", "rod", "explo"
        };
    ...
    private static Particle[] particles =
        {
            Particle.HEART, Particle.SPELL_MOB, Particle.SPELL_WITCH, Particle.FLAME, Particle.LAVA, Particle.TOTEM,
            Particle.NOTE, Particle.DAMAGE_INDICATOR, Particle.SLIME, Particle.SNOWBALL, Particle.VILLAGER_ANGRY,
            Particle.VILLAGER_HAPPY, Particle.REDSTONE, Particle.WATER_DROP, Particle.CRIT_MAGIC, Particle.END_ROD,
            Particle.EXPLOSION_NORMAL
        };

    public static Particle[] getParticles() { return particles; }
}
