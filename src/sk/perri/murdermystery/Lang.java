...
class Lang
{
  ...
  static String PLAYER = ChatColor.GRAY + "Hráč";
  static String CONNECTED = ChatColor.GRAY + "se připojil.";
  static String ABLE_TO_START = ChatColor.GRAY + "Připojilo se dostatečné množství hráčů, hra začne za " + ChatColor.RED + "60 sekund" + ChatColor.GRAY + "!";
  
  static String G_W_START_IN = ChatColor.GRAY + "Hra začne za";
  ...
  static String W_CD_MSG = ChatColor.GRAY + "Vrah a detektiv dostanou svoje zbraně za " + ChatColor.RED + "15 sekund" + ChatColor.GRAY + "!";
  ...
  static String GAME_START = ChatColor.RED + "HRA ZAČÍNÁ!";
  static String GAME_OVER = ChatColor.RED + "HRA SKONČILA!";
  ...
  static String DET_DEAD = ChatColor.RED + "Detektiv padl!" + ChatColor.GRAY + " Na místě jeho úmrtí zůstal luk!" + ChatColor.RED + " Seber ho a zabij vraha!";
  
  static String DEAD_MSG = ChatColor.GRAY + "Zemřel hráč ";
