...
class Lang
{
    ...
    static String ABLE_TO_START = ChatColor.GRAY+"Připojilo se dostatečné množství hráčů, hra začne za "+ChatColor.RED+
            "60 sekund"+ChatColor.GRAY+"!";
    ...
    static String W_CD_MSG = ChatColor.GRAY+"Vrah a detektiv dostanou svoje zbraně za "+ ChatColor.RED+
            "15 sekund"+ChatColor.GRAY+"!";
    ...
    static String DET_DEAD = ChatColor.RED+"Detektiv padl!"+ChatColor.GRAY+" Na místě jeho úmrtí zůstal luk!"+
            ChatColor.RED+" Seber ho a zabij vraha!";
